...
S = [
 ...
 ("Wheel spin speeds", "ω_FL, ω_FR, ω_RL, ω_RR", "states 7–10",
  "Wheel rotational speeds, one per corner — real states with their own differential equation I·ω̇ = T − r·Fx.",
 ...
 ("Wheel torques", "T_FL, T_FR, T_RL, T_RR", "torque_allocator.py output",
 ...
 ("Total drive power", "P", "logged",
  "Mechanical power at the wheels: Σ T_i·ω_i over the four wheels.",
